...
class PlacesHistoryStorageTest {
    ...
    fun `get history metadata since`() = runBlocking {
        ...
        with(history.getHistoryMetadataSince(beginning)) {
            ...
            assertHistoryMetadataRecord(metaKey2, 2000, DocumentType.Regular, this[0])
            assertHistoryMetadataRecord(metaKey3, 200, DocumentType.Media, this[1])
            assertHistoryMetadataRecord(metaKey1, 20000, DocumentType.Regular, this[2])
        }
