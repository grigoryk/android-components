...
/**
 * Represents the different type of history metadata observations.
 */
...
/**
 * Represents a set of history metadata values that can uniquely identify a record. Note that
