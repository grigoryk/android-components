...
object Deps {
    ...
    const val arch_room = "android.arch.persistence.room:runtime:${Versions.room}"
    const val arch_room_annotations = "android.arch.persistence.room:compiler:${Versions.room}"
